...
### [Work Log | Development line] v0.86.02

`v0.86.02` consolidates the active feature line after the recent OS AI,
...
replacement executable before launching a self-replacement script or closing
the running editor.
