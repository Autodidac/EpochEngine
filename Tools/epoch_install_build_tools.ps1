<#
    ...
    Examples (CLI):
        ./epoch_install_build_tools.ps1 --cmake --ninja
        ./epoch_install_build_tools.ps1 --bundle core
        ./epoch_install_build_tools.ps1 --bundle full
        ./epoch_install_build_tools.ps1 --msvc --clang
        ./epoch_install_build_tools.ps1 --vscode --vscode_ext_cpp
        ./epoch_install_build_tools.ps1 --bundle core --portable
#>
...
$script:LogFile   = Join-Path $PSScriptRoot "epoch_install.log"
...
function Help {
    Write-Host "Epoch Toolchain Installer"
    Write-Host ""
...
function Start-EpochInstallerGui {
    Add-Type -AssemblyName System.Windows.Forms
    Add-Type -AssemblyName System.Drawing

    $form = New-Object System.Windows.Forms.Form
    $form.Text = "Epoch Toolchain Installer"
    ...
    $run.Add_Click({
        ...
        $logBox.AppendText("See epoch_install.log for full details.`r`n")
    })
