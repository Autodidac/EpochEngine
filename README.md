...
- Source is currently the packaged-release line at `v0.87.52`.
...
- Release checkpoint: `v0.87.52` repairs Linux source-update vcpkg provisioning,
  keeps the incompatible static Raylib lane out of Linux packages, and remains
  the packaged source line for this tagged release.
