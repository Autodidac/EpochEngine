...
#define ALMOND_USING_OPENGL 0
#define ALMOND_USING_SFML 0
#define ALMOND_USING_RAYLIB 0
#define ALMOND_USING_SDL 0
#define ALMOND_USING_SOFTWARE_RENDERER 0
...
#endif
#if defined(ALMOND_USING_OPENGL) && (ALMOND_USING_OPENGL == 1) && !defined(EPOCH_USING_OPENGL)
...
#endif
#if defined(ALMOND_USING_RAYLIB) && (ALMOND_USING_RAYLIB == 1) && !defined(EPOCH_USING_RAYLIB)
#define EPOCH_USING_RAYLIB ALMOND_USING_RAYLIB
#endif
#if defined(ALMOND_USING_SDL) && (ALMOND_USING_SDL == 1) && !defined(EPOCH_USING_SDL)
