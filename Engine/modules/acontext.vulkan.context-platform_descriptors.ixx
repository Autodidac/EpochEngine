// acontext.vulkan.context-platform_descriptors.ixx
// Placeholder module partition for descriptor helpers (currently disabled).

//module acontext.vulkan.context:platform_descriptors;
