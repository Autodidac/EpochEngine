...
- Backend-native implementations behind the formal renderer resource model:
  ...
  model-handle and sampled-RTT lane, and broader backend allocation/feature
  parity is the active gate.
