...
explicit nearest/linear selection. Raylib3 and Vulkan consume that policy in
their backend-owned filter/sampler selection; native blend, UV, and draw order
remain backend-owned. This is source/build evidence only and adds no pixel claim.
