...
- Backend-native implementations behind the formal renderer resource model:
  ...
  sampled-RTT graph contract, and broader backend allocation/feature parity is
  the active gate.
