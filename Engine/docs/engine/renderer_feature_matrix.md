...
- Backend-native implementations behind the formal renderer resource model:
  ...
  sampled-RTT plus arcade-cabinet material/model graph contract, OpenGL has the
  first FBO-backed hook factory, and broader backend allocation/feature parity
  is the active gate.
