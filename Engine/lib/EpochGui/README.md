...
layout library. The current mirror metadata tracks the EpochEngine `v0.87.26`
...
- `epoch/gui/version.hpp` for the mirror name and `0.87.26` version constants
...
The CMake project version is `0.87.26`, matching the engine source line that
separated toolbar context selection from reusable floating GUI layout state and
added guarded SFML/Raylib context handoff warnings.
