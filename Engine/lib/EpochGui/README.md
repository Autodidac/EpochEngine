...
layout library. The current mirror metadata tracks the EpochEngine `v0.87.39`
...
- `epoch/gui/version.hpp` for the mirror name and `0.87.39` version constants
...
The CMake project version is `0.87.39`, matching the engine source line that
