...
stable release and `v0.88.01` source line. The canonical EpochEngine source
...
- `epoch.gui` for the library name and `0.88.01` version constants
...
The CMake project version is `0.88.1`, matching the engine source line that
