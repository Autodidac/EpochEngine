...
layout library. The current mirror metadata tracks the EpochEngine `v0.87.58`
stable release and `v0.87.58` source line. The canonical EpochEngine source
...
- `epoch.gui` for the library name and `0.87.58` version constants
...
The CMake project version is `0.87.58`, matching the engine source line that
