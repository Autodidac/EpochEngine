...
stable release and `v0.87.66` source line. The canonical EpochEngine source
...
- `epoch.gui` for the library name and `0.87.66` version constants
...
The CMake project version is `0.87.66`, matching the engine source line that
