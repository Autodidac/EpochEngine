...
layout library. The current mirror metadata tracks the EpochEngine `v0.87.46`
...
- `gui/version.hpp` for the mirror name and `0.87.46` version constants
...
The CMake project version is `0.87.46`, matching the engine source line that
