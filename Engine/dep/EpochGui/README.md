...
release candidate and source line. The canonical EpochEngine source
...
- `epoch.gui` for the library name and `0.87.56` version constants
...
The CMake project version is `0.87.56`, matching the engine source line that
