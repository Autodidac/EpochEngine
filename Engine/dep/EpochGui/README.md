...
stable release and `v0.88.70` source line. The canonical EpochEngine source
...
- `epoch.gui` for the library name and `0.88.70` version constants

``epochnamespace::gui_lib`. New integrations should
prefer:
...
``0.88.1`, matching the engine source line that
