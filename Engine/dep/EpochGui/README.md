...
layout library. The current mirror metadata tracks the EpochEngine `v0.87.48`
...
- `gui/version.hpp` for the mirror name and `0.87.48` version constants
...
The CMake project version is `0.87.48`, matching the engine source line that
